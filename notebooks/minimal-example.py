...
# %%
fig1 = KE.plot_data(us_train1, ys_train1)
fig2 = KE.plot_data(us_train2, ys_train2)
plt.show()
...
problemTrain = KE.ProblemParser(model, [ys_train1, ys_train2], [us_train1, us_train2], x0, P0, lti=True)
